export const translation_ja = {
  ...
  top: {
    ...
    history: "更新履歴",
    changelog: [
      "2026/06/27 zipのルートフォルダが空文字列のとき、周波数表関係の処理がうまくいかない不具合の修正",
      ...
      "2026/01/03 ブラウザの自動翻訳機能使用時にアプリが異常終了する不具合への対策",
      "2026/01/01 音源パッケージ生成時にメモリ消費量が増加する不具合の修正",
  ...
  editor: {
    ...
    otoini: {
      title: "oto.ini",
      description: "oto.iniの文字コードを修正します。内容の編集はできません。",
      check: "oto.iniの文字コードを修正",
      encoding: "文字コード",
      selectFile: "プレビューするoto.ini",
      preview: "プレビュー（文字化けがある場合は文字コードを変更してください）",
      noFiles: "oto.iniファイルが見つかりません。",
    },
    output: "zipファイルを生成する",
    download: "ダウンロード",
  },
